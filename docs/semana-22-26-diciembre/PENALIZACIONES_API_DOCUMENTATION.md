...
```json
{
  ...
  "tipo": "Penalización aplicada cuando el estudiante no asiste a una clase programada sin justificación previa",
  "description": "Descripción detallada de la penalización",
  "status": 1,
  "nivel": 1,
  "statusText": "Activo",
...
- `tipo` (string): Tipo de penalización (opcional, por defecto: null) - **Nota: Campo pendiente de implementación**
- `description` (string): Descripción de la penalización (opcional, por defecto: null)
- `status` (number): Estado de la penalización
  - `1` = Activo
  - `2` = Anulado
- `nivel` (number): Nivel de penalización (opcional, por defecto: null)
...
#### **Campos Opcionales**
- `tipo` (string): Tipo de penalización
  - **Requisitos**: 
    - Puede estar vacío o ser null
    - Si se proporciona, se guardará tal como se envía (con trim aplicado)
  - **Nota**: Campo pendiente de implementación
- `description` (string): Descripción de la penalización
  - **Requisitos**: 
    - Puede estar vacío o ser null
    - Si se proporciona, se guardará tal como se envía (con trim aplicado)
- `nivel` (number): Nivel de penalización
  - **Requisitos**: 
    - Puede ser null
...
[
  ...
  },
  {
    ...
    "tipo": "Penalización aplicada cuando el estudiante no completa las tareas asignadas",
    "description": "Descripción de la penalización por no completar tareas",
    "status": 2,
    "nivel": null,
    "statusText": "Anulado",
...
- Los campos `tipo`, `description` y `nivel` son **opcionales**
- Se pueden actualizar los campos `name`, `tipo`, `description` y `nivel`
